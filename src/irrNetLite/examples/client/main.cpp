...
video::IVideoDriver* globaldriver;
 scene::IAnimatedMeshSceneNode* globalnode;
 char myusername[20];
/*
...
int main()
{
    ...
    net::INetManager* netManager = net::createIrrNetClient(clientCallback, serveraddress);
			...
			netManager->sendOutPacket(packetout);
				net::SOutPacket packetout1;
            packetout1 << 3;
			packetout1 << "luckyluke";
			packetout1 << core::vector3df(50.0f, 30.0f, 20.0f);
			packetout1 << 52.2f;
			packetout1 << 23.2f;
			packetout1.compressPacket();
			packetout1.encryptPacket("hushthisissecret");
			netManager->sendOutPacket(packetout);*/
	...
	*/
	...
	scene::ITerrainSceneNode* terrain = smgr->addTerrainSceneNode(
		"../../../irrlicht/media/terrain-heightmap.bmp",
		0,					// parent node
		-1,					// node id
	...
	terrain->setMaterialTexture(0,
			driver->getTexture("../../../irrlicht/media/terrain-texture.jpg"));
	...
	*/
	...
	scene::ISceneNode* skybox=smgr->addSkyBoxSceneNode(
		driver->getTexture("../../../irrlicht/media/irrlicht2_up.jpg"),
		driver->getTexture("../../../irrlicht/media/irrlicht2_dn.jpg"),
		driver->getTexture("../../../irrlicht/media/irrlicht2_lf.jpg"),
		driver->getTexture("../../../irrlicht/media/irrlicht2_rt.jpg"),
		driver->getTexture("../../../irrlicht/media/irrlicht2_ft.jpg"),
		driver->getTexture("../../../irrlicht/media/irrlicht2_bk.jpg"));
...
net::SOutPacket packetout;
  ...
  IAnimatedMesh* mesh = smgr->getMesh("../../../irrlicht/media/sydney.md2");
	...
	if (device->isWindowActive())
	{
		...
		if(true)
		{
           cout << "\nstarting networkingpart"<<endl;
            netManager->update(100);
			packetout << 3;//we're sending a regular update message
			packetout << myusername;
			vector3df cameraPosition = camera->getPosition();
			packetout << cameraPosition;
			f32 cameraRotation = camera->getRotation().Y;
			packetout << cameraRotation;
			packetout << 23.2f;
			packetout.compressPacket();
			packetout.encryptPacket("hushthisissecret");
			netManager->sendOutPacket(packetout);
			cout << "\ndone sending stuffs"<<endl;
